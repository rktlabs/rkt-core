...
class ActivityRepository extends repositoryBase_1.RepositoryBase {
    ...
    getListAsync(qs) {
        return __awaiter(this, void 0, void 0, function* () {
            let entityRefCollection = this.db.collection(ACTIVITY_COLLECTION_NAME);
    ...
    atomicUpdateTransactionAsync(updateSet, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updates = updateSet.map((updateItem) => {
                ...
                const source = (_a = transaction.tags) === null || _a === void 0 ? void 0 : _a.source;
                const refTradeId = (_b = transaction.xids) === null || _b === void 0 ? void 0 : _b.tradeId;
                const refOrderId = (_c = transaction.xids) === null || _c === void 0 ? void 0 : _c.orderId;
                const refOrderPortfolioId = (_d = transaction.xids) === null || _d === void 0 ? void 0 : _d.orderPortfolioId;
                ...
                if (refOrderId)
                    activityItem.refOrderId = refOrderId;
                if (refOrderPortfolioId)
                    activityItem.refOrderPortfolioId = refOrderPortfolioId;
                if (refTradeId)
                    activityItem.refTradeId = refTradeId;
                return {
