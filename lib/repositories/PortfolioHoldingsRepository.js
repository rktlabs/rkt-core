...
exports.PortfolioHoldingsRepository = void 0;
...
class PortfolioHoldingsRepository extends repositoryBase_1.RepositoryBase {
    constructor() {
        super();
        this.db = (0, getConnectionProps_1.getConnectionProps)();
    }
    listPortfolioHoldings(portfolioId) {
    ...
    getPortfolioHolding(portfolioId, assetId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    storePortfolioHolding(portfolioId, assetId, entity) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.PortfolioHoldingsRepository = PortfolioHoldingsRepository;
