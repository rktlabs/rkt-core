...
const __1 = require("..");
const kMaker_1 = require("../services/marketMakerService/marketMakersServiceImpls/kMaker");
...
class MarketMakerFactory {
    ...
    getMarketMakerAsync(assetId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (makerType) {
                case 'constantk':
                    marketMakerService = new kMaker_1.KMaker(this.assetRepository, this.portfolioRepository, this.transactionRepository, this.marketMakerRepository, makerDef);
                    break;
    ...
    _createMarketMakerImpl(config, shouldCreatePortfolio) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (config.type) {
                case 'constantk':
                    marketMaker = kMaker_1.KMaker.newMaker(this.assetRepository, this.portfolioRepository, this.transactionRepository, this.marketMakerRepository, config);
                    break;
                case 'constantBondingCurveAMM':
