...
exports.PortfolioFactory = void 0;
const __1 = require("..");
...
class PortfolioFactory {
    ...
    createPortfolio(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const portfolio = yield this._createPortfolioImpl(payload);
    ...
    createOrKeepPortfolio(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!portfolio) {
                portfolio = yield this._createPortfolioImpl(payload);
                logger.trace(`created portfolio: ${portfolio.portfolioId}`);
            }
            return portfolio;
        });
...
exports.PortfolioFactory = PortfolioFactory;
