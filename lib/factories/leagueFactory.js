...
class LeagueFactory {
    constructor(leagueRepository, assetRepository, portfolioRepository, marketMakerRepository, transactionRepository) {
        ...
        this.portfolioService = new _1.PortfolioFactory(portfolioRepository);
        this.assetService = new _1.AssetFactory(assetRepository, portfolioRepository, marketMakerRepository, transactionRepository);
    }
