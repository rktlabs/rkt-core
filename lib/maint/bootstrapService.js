...
class BootstrapService {
    constructor(assetRepository, portfolioRepository, transactionRepository, userRepository, marketMakerRepository, leagueRepository) {
        this.userService = new __1.UserService(portfolioRepository, userRepository);
        ...
        this.assetService = new __1.AssetService(assetRepository, portfolioRepository, marketMakerRepository, transactionRepository);
        this.portfolioService = new __1.PortfolioService(portfolioRepository);
        this.leagueService = new __1.LeagueService(leagueRepository, assetRepository, portfolioRepository, marketMakerRepository, transactionRepository);
    }
    bootRkt() {
    ...
    bootstrap() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all([this.bootRkt(), this.bootBank(), this.bootUser(), this.bootLeague(), this.bootAssets()]);
        });
    }
}
