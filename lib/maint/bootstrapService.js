...
class BootstrapService {
    constructor(assetRepository, portfolioRepository, transactionRepository, userRepository) {
        ...
        this.assetService = new __1.AssetService(assetRepository, portfolioRepository, transactionRepository);
        this.portfolioService = new __1.PortfolioService(portfolioRepository);
        this.leagueService = new __1.LeagueService(assetRepository, portfolioRepository, transactionRepository);
    }
    bootRkt() {
