...
class BootstrapService {
    constructor(assetRepository, portfolioRepository, transactionRepository, userRepository, marketMakerRepository, leagueRepository) {
        ...
        this.userFactory = new __1.UserFactory(portfolioRepository, userRepository);
        this.marketMakerFactory = new __1.MarketMakerFactory(assetRepository, portfolioRepository, transactionRepository, marketMakerRepository);
        this.assetFactory = new __1.AssetFactory(assetRepository, portfolioRepository);
        this.portfolioFactory = new __1.PortfolioFactory(portfolioRepository);
        this.leagueFactory = new __1.LeagueFactory(leagueRepository, assetRepository, portfolioRepository);
    }
    static boot() {
    ...
    bootRkt() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.assetFactory.createAsset(assetDef);
        });
    }
    bootBank() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.portfolioFactory.createOrKeepPortfolio({
                type: 'bank',
                ownerId: 'test',
    ...
    bootLeague() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.leagueFactory.createLeague({
                ownerId: 'test',
                leagueId: 'test',
                tags: {
                    test: true,
    ...
    bootUser() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.userFactory.createUser({
                userId: userId,
                dob: '1963-05-07',
    ...
    bootAsset(assetId) {
        return __awaiter(this, void 0, void 0, function* () {
            const leagueId = 'test';
            yield this.scrubber.scrubAsset(assetId);
            yield this.assetFactory.createAsset({
                ownerId: 'test',
                symbol: assetId,
                displayName: assetId,
                leagueId: leagueId,
            ...
            yield this.leagueFactory.attachAsset(leagueId, { assetId: assetId, displayName: assetId });
            const makerConfig = {
            ...
            yield this.marketMakerFactory.createMarketMaker(makerConfig, false);
        });
    }
    bootAssets() {
        return __awaiter(this, void 0, void 0, function* () {
