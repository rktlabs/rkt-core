...
class PortfolioService {
    ...
    deletePortfolio(portfolioId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let makerIds = yield marketMakerRepository.isPortfolioUsed(portfolioId);
            if (makerIds) {
                throw new __1.ConflictError(`Cannot Delete Portfolio. MarketMaker Portfolio in use: ${makerIds}`);
            }
            ...
            if (userIds) {
                throw new __1.ConflictError(`Cannot Delete Portfolio. Portfolio linked to user: ${userIds}`);
            }
    ...
    scrubPortfolio(portfolioId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const assetHolderService = new _1.AssetHolderService();
