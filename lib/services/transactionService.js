        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // commit the batch
                {
                    ...
                    yield this.assetHolderService.processTransaction(updates, transaction);
                }
            ...
            if (transaction.inputs) {
                ...
                for (let i = 0; i < inputLegs.length; ++i) {
                    ...
                    if (canShort) {
                        ...
                        if (!holding) {
                            // eslint-disable-next-line no-await-in-loop
                            holding = yield this.assetHolderService.createAssetHolder(assetId, portfolioId);
                        }
                    }
                    if (!holding) {
