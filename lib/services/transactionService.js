...
class TransactionService {
    ...
    mintCoinsToPortfolio(portfolioId, units, sourcePortfolioId = 'contract::mint', assetId = 'coin::rkt') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (transaction.inputs) {
                ...
                for (let i = 0; i < inputLegs.length; ++i) {
                    ...
                    if (canShort) {
                        ...
                        if (!holding) {
                            // eslint-disable-next-line no-await-in-loop
                            holding = yield this.portfolioHoldingsService.newPortfolioHolding(portfolioId, assetId);
                        }
                    }
                    if (!holding) {
