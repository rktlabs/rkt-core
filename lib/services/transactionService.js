...
class TransactionService {
    constructor(eventPublisher) {
        this.eventPublisher = eventPublisher || new _1.EventPublisher({ logger: logger });
        ...
        this.portfolioHoldingsService = new _1.PortfolioHoldingsService();
    }
    /////////////////////////////
    // Public Methods
    /////////////////////////////
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // commit the batch
                {
                    ...
                    yield this.portfolioHoldingsService.proessTransaction(transactionId, updates, transaction);
                }
    ...
    mintCoinsToPortfolio(portfolioId, units, sourcePortfolioId = 'league::mint', assetId = 'coin::rkt') {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    mintCoinsToPortfolioImpl(portfolio, units, sourcePortfolioId, assetId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.executeTransactionAsync(newTransactionData);
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (transaction.inputs) {
                ...
                for (let i = 0; i < inputLegs.length; ++i) {
                    ...
                    let holding = yield this.portfolioHoldingsRepository.getDetailAsync(portfolioId, assetId);
                    if (canShort) {
                        ...
                        if (!holding) {
                            // eslint-disable-next-line no-await-in-loop
                            holding = yield this.portfolioHoldingsService.createPortfolioHolding(portfolioId, assetId);
                        }
                    }
                    if (!holding) {
                    ...
                    const unitCost = holding.units === 0 ? 0 : (0, __1.round4)((holding.cost || 0) / holding.units);
                    if (!isCoin) {
                        inputLeg._unitCost = unitCost;
                        inputLeg._deltaCost = (0, __1.round4)(unitCost * units);
                        inputLeg._deltaNet = (0, __1.round4)(inputLeg.cost || 0) * -1;
                    }
                }
            }
            //////////////////////////
            ...
            if (transaction.outputs) {
                ...
                for (let i = 0; i < outputLegs.length; ++i) {
                    ...
                    if (!isCoin) {
                        outputLeg._deltaCost = (0, __1.round4)(outputLeg.cost || 0);
                        outputLeg._deltaNet = (0, __1.round4)(outputLeg.cost || 0) * -1;
                    }
                }
            }
        });
