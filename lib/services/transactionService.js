        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // commit the batch
                {
                    ...
                    yield this.portfolioHoldingService.proessTransaction(transactionId, updates, transaction);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (transaction.inputs) {
                ...
                for (let i = 0; i < inputLegs.length; ++i) {
                    ...
                    let holding = yield this.portfolioHoldingRepository.getDetailAsync(portfolioId, assetId);
                    if (canShort) {
                        ...
                        if (!holding) {
                            // eslint-disable-next-line no-await-in-loop
                            holding = yield this.portfolioHoldingService.createPortfolioHolding(portfolioId, assetId);
                        }
                    }
                    if (!holding) {
