...
class TreasuryService {
    ...
    constructor(assetRepository, portfolioRepository, eventPublisher) {
        ...
        this.portfolioService = new _1.PortfolioService(portfolioRepository);
        this.assetHolderService = new __1.AssetHolderService(assetRepository);
        this.transactionService = new _1.TransactionService(assetRepository, portfolioRepository, this.eventPublisher);
        this.mintService = new _1.MintService(assetRepository, portfolioRepository);
    }
    mintUnits(units) {
    ...
    depositCoins(userId, units) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.portfolioService.recordPortfolioDeposit(deposit);
        });
    }
