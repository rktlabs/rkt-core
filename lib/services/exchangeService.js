...
class ExchangeService {
    constructor(assetRepository, portfolioRepository, transactionRepository, marketMakerRepository, portfolioOrderRepository, eventPublisher) {
        ...
        // PRIVATE
        ////////////////////////////////////////////////////////
        this._updateExchangeOrder = (portfolioId, orderId, payload) => __awaiter(this, void 0, void 0, function* () {
        ...
        ////////////////////////////////////////////////////
        this._onTrade = (trade) => __awaiter(this, void 0, void 0, function* () {
            yield this.exchangeTradeRepository.storeAsync(trade); // async - don't wait to finish
            yield this.portfolioOrderEventService.processCompleteEvent({
        ...
        ////////////////////////////////////////////////////
        this._onUpdateQuote = (marketMaker) => __awaiter(this, void 0, void 0, function* () {
    ...
    ////////////////////////////////////////////////////
    processNewExchangeOrderEvent(orderPayload) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (marketMaker) {
                    ...
                    const order = __1.MarketMakerFactory.generateOrder({
                        assetId: assetId,
                        orderId: orderId,
                    ...
                    if (trade) {
                        if (trade.taker.filledSize) {
                            yield this._onFill(trade);
                            yield this._onTrade(trade);
                            yield this._onUpdateQuote(marketMaker);
                            ...
                            yield this._processTransaction(orderId, exchangeOrder.assetId, trade.tradeId, takerPortfolioId, takerDeltaUnits, takerDeltaValue, makerPortfolioId);
                        }
                    }
                }
            }
                ...
                if (exchangeOrder && exchangeOrder.status === 'received') {
                    ...
                    yield this.exchangeOrderRepository.updateAsync(exchangeOrder.portfolioId, exchangeOrder.orderId, updateData);
    ...
    _onFill(trade) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._updateExchangeOrder(portfolioId, orderId, {
    ...
    ////////////////////////////////////////////////////
    _processTransaction(orderId, assetId, tradeId, takerPortfolioId, takerDeltaUnits, takerDeltaValue, makerPortfolioId) {
        return __awaiter(this, void 0, void 0, function* () {
