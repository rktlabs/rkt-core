...
class ExchangeService {
    constructor(eventPublisher) {
        ...
        this.marketMakerService = new __1.MarketMakerService();
    }
    ////////////////////////////////////////////////////
    ...
    processNewExchangeOrderAsync(orderPayload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // Process the order
                ////////////////////////////////////////////////////////
                const maker = yield this.marketMakerService.getMakerAsync(assetId);
                if (maker) {
                    const trade = yield maker.processOrder(order);
                    if (trade) {
