    ...
    processOrder(orderSource) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // Process the order
                ////////////////////////////////////////////////////////
                const marketMaker = yield this.marketMakerFactory.getMarketMakerAsync(assetId);
                if (marketMaker) {
                    ////////////////////////////////////////////////////////
                    ...
                    if (orderSide === 'bid') {
                        ...
                        ////////////////////////////
                        const currentPrice = ((_a = marketMaker === null || marketMaker === void 0 ? void 0 : marketMaker.marketMaker.quote) === null || _a === void 0 ? void 0 : _a.ask) || 1;
                    ...
                    // and STORE it
                    ////////////////////////////////////
                    exchangeOrder = __1.ExchangeOrder.newExchangeOrder(orderSource);
                    yield this.exchangeOrderRepository.storeAsync(exchangeOrder);
                    yield marketMaker.processOrder(exchangeOrder);
                }
            }
            catch (error) {
