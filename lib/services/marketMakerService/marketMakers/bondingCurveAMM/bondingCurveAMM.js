...
class BondingCurveAMM extends __1.MarketMakerBase {
    ...
    static newMaker(assetRepository, portfolioRepository, transactionRepository, marketMakerRepository, props) {
        ...
        const newEntity = new BondingCurveAMM(assetRepository, portfolioRepository, transactionRepository, marketMakerRepository, makerProps);
    ...
    processOrderImpl(orderSide, orderSize) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (orderSide == 'bid' && orderSize > 0) {
                ...
                const assetPortfolioHoldings = yield this.assetHolderRepository.getDetailAsync(asset.assetId, asset.portfolioId);
