        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (makerType) {
                ...
                case 'bondingCurveAMM':
                    marketMaker = new _1.BondingCurveAMM(this.assetRepository, this.portfolioRepository, this.transactionRepository, makerDef);
                    break;
            }
            return marketMaker;
        });
    ...
    createMarketMakerImpl(config, shouldCreatePortfolio) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (config.type) {
                ...
                default:
                case 'bondingCurveAMM':
                    marketMaker = _1.BondingCurveAMM.newMaker(this.assetRepository, this.portfolioRepository, this.transactionRepository, config);
                    break;
            }
            if (shouldCreatePortfolio) {
