...
class PortfolioOrderEventService {
    constructor(portfolioOrderRepository) {
        ...
        this.processFailEvent = (order) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (portfolioOrder.orderStatus) {
                ...
                case 'failed':
                default:
                    logger.warn(`handleOrderEvent: handleFailedEvent(${portfolioOrder.orderId}) orderStatus: ${portfolioOrder.orderStatus} - ${order} - IGNORED`);
                    break;
            }
