...
class SimpleExchangeService {
    constructor(assetRepository, portfolioRepository, transactionRepository, userRepository, marketMakerRepository, eventPublisher) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tradeUnits) {
                ...
                if (makerDeltaUnits) {
                    ...
                    yield this._process_transaction(orderId, assetId, tradeId, takerPortfolioId, takerDeltaUnits, takerDeltaValue, makerPortfolioId);
                }
            }
        });
    }
    ...
    ////////////////////////////////////////////////////
    _process_transaction(orderId, assetId, tradeId, takerPortfolioId, takerDeltaUnits, takerDeltaValue, makerPortfolioId) {
        return __awaiter(this, void 0, void 0, function* () {
