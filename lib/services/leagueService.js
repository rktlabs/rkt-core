...
class LeagueService {
    ...
    newAsset(leagueSpec, assetDef) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.newAssetImpl(league, assetDef);
        });
    }
    dropAsset(leagueSpec, assetId) {
        return __awaiter(this, void 0, void 0, function* () {
            const league = typeof leagueSpec === 'string' ? yield this.leagueRepository.getDetailAsync(leagueSpec) : leagueSpec;
            if (!league) {
                throw new Error(`League Not Found: ${leagueSpec}`);
            }
            yield this.dropAssetFromLeague(league, assetId);
        });
    }
    ///////////////////////////////////////////////////////
    // PRIVATE
    ...
    addAssetToLeague(league, asset) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.leagueRepository.addLeagueAsset(league.leagueId, asset);
        });
    }
    dropAssetFromLeague(league, assetId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.leagueRepository.dropLeagueAsset(league.leagueId, assetId);
        });
    }
    createLeaguePortfolioImpl(league) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const portfolio = yield this.portfolioService.newPortfolio(leaguePortfolioDef);
            return portfolio.portfolioId;
        });
    }
    newAssetImpl(league, assetDef) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.addAssetToLeague(league, asset);
            }
            catch (err) {
