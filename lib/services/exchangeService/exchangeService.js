...
class ExchangeService {
    constructor(eventPublisher) {
        ...
        this.orderEventPublisher = eventPublisher || new __1.EventPublisher();
    ...
    verifyAssetsAsync(exchangeOrder) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (unitsRequired > 0) {
                const portfolioHoldings = yield this.portfolioHoldingsRepository.getDetailAsync(portfolioId, assetId);
    ...
    verifyFundsAsync(exchangeOrder, price) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (coinsRequired > 0) {
                const coinsHeld = yield this.portfolioHoldingsRepository.getDetailAsync(portfolioId, paymentAssetId);
