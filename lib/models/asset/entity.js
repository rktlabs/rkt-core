...
class Asset {
    ...
    static validate(jsonPayload) {
        ...
        try {
            return validator_1.validate(jsonPayload);
        }
        catch (error) {
            // ValdationError
    ...
    static serialize(selfUrl, baseUrl, data) {
        return serializer_1.serialize(selfUrl, baseUrl, data);
    }
    static serializeCollection(selfUrl, baseUrl, qs, data, rowcount) {
        return serializer_1.serializeCollection(selfUrl, baseUrl, qs, data, rowcount);
    }
}
exports.Asset = Asset;
