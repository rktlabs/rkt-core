...
describe.only('ExchangerService', function () {
    describe('persist market maker', function () {
        ...
        before(() => __awaiter(this, void 0, void 0, function* () {
            ...
            exchangeService = new src_1.ExchangeService();
            treasuryService = new src_1.TreasuryService();
            mintService = new src_1.MintService();
            marketMakerRepository = new src_1.MarketMakerRepository();
            yield bootstrapper.bootstrap();
            yield bootstrapper.bootUser();
            yield treasuryService.depositCoins('testbot', 100);
            yield mintService.mintUnits(assetId, 100);
        ...
        describe('buy', function () {
            ...
            describe('Create Basic MarketMaker', () => __awaiter(this, void 0, void 0, function* () {
                it('should create', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield exchangeService.processNewExchangeOrderAsync(orderPayload);
